  ...
  include("../../../conectar.php"); 
   ...
   $sql = "SELECT * FROM (
               SELECT
                  ...
                  WHERE Criterio = 'Calidad' OR Criterio = 'General'
                  GROUP BY Mes
               UNION ALL
                  SELECT 
                        2 AS id,
                     ...
                     FROM 
                        rep_InspeccionesEnObras
                     WHERE (Criterio = 'Calidad' OR Criterio = 'General') AND tipoDefecto = 'T1'
                     GROUP BY Mes
               Union ALL
                  SELECT 
                        3 AS id,
                     ...
                     FROM 
                        rep_InspeccionesEnObras
                     WHERE (Criterio = 'Calidad' OR Criterio = 'General') AND tipoDefecto IS NULL
                     GROUP BY Mes
                  ) AS Datos 
               ORDER BY Mes, id;";
